...
Then [fork the WoosterTech/audiobookshelf-sdk repo](https://github.com/WoosterTech/audiobookshelf-sdk/fork) (having your own fork will make it easier to contribute) and [clone it](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository).
